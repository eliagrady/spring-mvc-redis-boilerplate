...
<div class="container-fluid">
    <div class="container-fluid thumbnail" style="margin-top:20px; padding:20px; box-shadow:#ccc 0 0 15px">
        <h1>Example App - Help</h1>

        <h2>Your App is alive!!! ??? ?123 123 </h2>
        <hr/>
        ...
        <ul>
            ...
            <li><a href=http://velocity.apache.org/engine/devel/user-guide.html>Velocity Documentation</a> (the
                src/main/resources/views/*.vm files)
            </li>
